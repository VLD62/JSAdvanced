  ...
  Array
    ...
    .map((x) => x.addEventListener("click", function nextSection(e) {
      ...
      if (document.querySelectorAll("section")[index + 1] !== undefined) {
        ...
        if (rightAnswered !== 3) {
          document.querySelector("#results h1").innerText = `You have ${rightAnswered} right answers`;
        } else {
          document.querySelector("#results h1").innerText = "You are recognized as top JavaScript fan!";
        }
      }
    }));
}